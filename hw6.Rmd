...
## 1. (2.5 points) Investigate whether there are any differences between countries in company mar- ket to book value (variable mtb). Draw a boxplot by group to visualise the distributions of company market to book value by country. Comment on the plot.

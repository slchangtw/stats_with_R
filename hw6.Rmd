...
```
South Africa and IR comparitively have higher company market to book value. However they are just margianlly larger. IR has the 3 outliers, of which one is quite distinctively away positively. The spread of Germany and South Africa are almost similar. Israel has the spread.
...
m_mtb
```
Germany has the largest ratio, Israel the smallest.
...
v_mtb
```
Israel has the highest variance of 4.207778. All the other countries have relative similarly variances.
...
anova(mtb_aov)
```
THe P value for is significant and hence the null hypothesis can be rejected in favour of the alternate hypothesis that the the meb varies based on the country. 
